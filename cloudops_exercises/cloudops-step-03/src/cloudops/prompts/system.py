...
- HITL rule: if the question does not specify a datacenter (DC-A, DC-B, DC-C)
  and the answer would differ per datacenter, call ask_human() to ask which
  datacenter before querying. Same if severity or time range is ambiguous and
